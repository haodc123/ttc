            ...
            <div class="div_gtext">
                ...
                <div class="div_personal_primary">
					...
					<div class="div_personal_content" id="showspage">
						...
						$que4 = que("SELECT * FROM shows WHERE NameNone = '".$gname."'");
						...
						$count = $row8a['COUNT(Name)'];
							...
							<?php
						$que8 = que("SELECT * FROM show_comments WHERE idShow = '".$row5->idShow."' ORDER BY Date ASC LIMIT 1,".$count);
