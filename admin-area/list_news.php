...
{
?>
			<h1 class="h1_up_title">Quản trị thông tin - Danh sách Tin tức :</h1>
			<div class="div_products">
				...
				// End Paging 1
					...
					$que_5 = que("SELECT * FROM news");
					$que5 = que("SELECT * FROM news ORDER BY Date DESC LIMIT ".$start.",".$perPage);
				...
				if ($num == 0) echo 'Chưa có Tin !';
				while ($row5 = mysql_fetch_object($que5))
				{
				
				?>
                <div class="div_product">
                	<a target="_blank" class="a_img" href="../detail_news.php?name=<?php echo $row5->NameNone; ?>"><img src="../images/<?php echo $row5->urlImg; ?>" alt="<?php echo $row5->Name; ?>" /></a>
                    <div class="info">
                        ...
                        <a target="_blank" class="a_name" href="../detail_news.php?name=<?php echo $row5->NameNone; ?>"><?php echo $row5->Name; ?></a><br />
                        <div class="clear"></div>
                        <h1>
							<?php
                            $que6 = que("SELECT * FROM users WHERE idUser = '".$row5->idUser."'");
                            $row6 = mysql_fetch_object($que6);
                            echo '<a href="../personal.php?do=info&name='.$row6->NameNone.'">'.$row6->Name.'</a>';
                            ?>
                        </h1>
                        <h2>
                        ...
                        <h4>Lượt View : <?php echo $row5->View; ?></h4>
                        <div class="clear"></div>
                        <h5>
							<?php 
							if ($row5->Active == 1)
                        ...
                        <h6>
                        	<a target="_blank" href="manager_news.php?name=<?php echo $row5->NameNone; ?>">Quản trị</a>
                        </h6>
                        <div class="clear"></div>
                    </div><!-- .info -->
                </div><!-- div_product -->
            ...
            <a target="_blank" href="manager_news.php?type=news&do=add">Thêm mới Tin tức</a>
                <?php
				if ($num <> 0) {
				?>
