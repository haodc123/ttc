...
<div id="container">
    ...
    <div id="eprimary">
		...
		{	
            ...
            <form class="fup" name="fup2p" method="post" action="do_up.php?type=products&step=1">
            ...
            <form class="fup" enctype="multipart/form-data" name="fup2" method="post" action="do_up.php?type=products&step=2p">
			...
			{
			?>
            <span style="color:#FF9900; margin: 20px 0 10px 20px;">Những mục có * là bắt buộc</span></p>
          <form class="fup" name="fup1" method="post" action="do_up.php?type=products&step=2">
                ...
                <?php
				$que11 = que("SELECT * FROM products WHERE idPost = '".$_SESSION['idPost']."' ORDER By Number ASC");
				while ($row11 = mysql_fetch_object($que11))
				{
					echo '<p><img class="img_up" src="images/'.$row11->urlImg.'" alt="'.$row11->Price.'" />';
				}
				?>
                    <div class="clear"></div>
                <label class="small">Nội dung shop hàng của bạn <span>*</span>: </label>
                Bạn có thể kéo thả các hình ảnh ở bên trên xuống hoặc
                <a target="_blank" class="a_help_up" href="help.php?do=sale#up_img">Đọc Hướng dẫn</a>
    ...
    ***************************************************/
    ...
    oEdit1.REPLACE("fupcontent");
		...
		elseif ($gerror == 'blankimg')
		{
            ...
            <p><a href="up_products.php?step=2p">Trở lại</a></p>
            <?php
		}
