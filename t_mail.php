...
$from = "khuyenmai@shop4la.com"; // Reply to this email
$to = "nguoixanhtihon@gmail.com"; // Recipients email ID
$name = "nguoixanhtihon"; // Recipient's name

$mail = new PHPMailer();
$mail->IsSMTP(); // set mailer to use SMTP
$mail->Host = "smtp.shop4la.com"; // specify main and backup server
$mail->Port = 25; // set the port to use
$mail->SMTPAuth = true; // turn on SMTP authentication
$mail->SMTPSecure = 'ssl';
$mail->Username = $from; // your SMTP username or your gmail username
$mail->Password = "shop4lamkh"; // your SMTP password or your gmail password

$mail->From = $from;
$mail->FromName = "SHOP4LA 2"; // Name to indicate where the email came from when the recepient received
